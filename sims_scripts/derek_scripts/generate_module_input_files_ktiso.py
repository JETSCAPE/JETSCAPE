...
e_dep_fs_time = 0 # switch for energy dependent freestreaming time 
e_R = 4.0 # GeV / fm
tau_R = 1.507 # fm / c
alpha = 0.113
...
T_c = 0.14 #switching temperature on hypersurface [GeV]
...
#ktiso file
ktiso_file = open('ita_input','w')

ktiso_file.write("output_format 2\n")
ktiso_file.write("ic_energy 5\n")
ktiso_file.write("ic_flow 1\n")
ktiso_file.write("nx " + str(nx) + "\n")
ktiso_file.write("ny " + str(ny) + "\n")
