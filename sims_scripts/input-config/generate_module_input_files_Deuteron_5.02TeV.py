...
cross_section = 7.0 #PbPb 5.02 TeV
#cross_section = 6.4 #PbPb 2.76 TeV
#cross_section = 4.2 #AuAu 200 GeV

normalization = 18.77 # PbPb 5.02 TeV
#normalization = 14.218 # PbPb 2.76 TeV
#normalization = 5.765 # AuAu 200 GeV
...
T_c = 0.136 #switching temperature on hypersurface [GeV]

#shear viscosity p'zation
eta_over_s_T_kink_in_GeV = 0.223
eta_over_s_low_T_slope_in_GeV = -0.756
eta_over_s_high_T_slope_in_GeV = 0.218
eta_over_s_at_kink = 0.096

#bulk viscosity p'zation
zeta_over_s_max = 0.129
zeta_over_s_width_in_GeV = 0.089
zeta_over_s_T_peak_in_GeV = 0.12
zeta_over_s_lambda_asymm = -0.194

#relaxation times
shear_relax_time_factor = 4.542
