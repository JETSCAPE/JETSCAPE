...
normalization = 14.43 # PbPb 2.76 TeV
#normalization = 6.08 # AuAu 200 GeV
...
T_c = 0.141 #switching temperature on hypersurface [GeV]

#shear viscosity p'zation
eta_over_s_T_kink_in_GeV = 0.22
eta_over_s_low_T_slope_in_GeV = -1.41
eta_over_s_high_T_slope_in_GeV = -0.038
eta_over_s_at_kink = 0.067

#bulk viscosity p'zation
zeta_over_s_max = 0.11
zeta_over_s_width_in_GeV = 0.076
zeta_over_s_T_peak_in_GeV = 0.197
zeta_over_s_lambda_asymm = -0.204

#relaxation times
shear_relax_time_factor = 4.95
