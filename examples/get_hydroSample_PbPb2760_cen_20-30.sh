...
$curlcmd "https://bitbucket.org/sscao/hydro_profiles/downloads/PbPb2760-Avg-20-30.tar.gz"

tar xvzf PbPb2760-Avg-20-30.tar.gz
mkdir -p test_hydro_files
mv PbPb2760-Avg-20-30 test_hydro_files/event-0
rm PbPb2760-Avg-20-30.tar.gz
