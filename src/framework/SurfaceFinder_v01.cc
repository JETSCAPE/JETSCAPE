...
SurfaceFinder_v01::SurfaceFinder_v01(const Jetscape::real T_in,
...
SurfaceFinder_v01::~SurfaceFinder_v01() { surface_cell_list.clear(); }

void SurfaceFinder_v01::Find_full_hypersurface() {
  if (boost_invariant) {
...
SurfaceCellInfo SurfaceFinder_v01::PrepareASurfaceCell(
    Jetscape::real tau, Jetscape::real x, Jetscape::real y, Jetscape::real eta,
