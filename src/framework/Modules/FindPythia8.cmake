...
If(PYTHIA8_FOUND)
  MESSAGE(STATUS "Looking for Pythia8 ... - found ${PYTHIA8_LIBRARIES}")
  Set(LD_LIBRARY_PATH ${LD_LIBRARY_PATH} ${PYTHIA8_LIBRARIES})
  Set(DYLD_LIBRARY_PATH ${DYLD_LIBRARY_PATH} ${PYTHIA8_LIBRARIES})
endif()
