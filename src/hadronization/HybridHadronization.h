...
{  
 ...
 private:
  ...
  double maxE_level, gmax, xmq, xms, hbarc, dist2cut, sh_recofactor, th_recofactor;
  ...
  protected:
	...
	bool is_shower_, is_thermal_, is_used_, is_decayedglu_, is_remnant_, used_reco_, used_str_, is_strendpt_;
	...
	int alt_id_, orig_, par_, string_id_, pos_str_, endpt_id_, sibling_, PY_par1_, PY_par2_, PY_dau1_, PY_dau2_, PY_stat_, PY_origid_;
	//parton mass
	double alt_mass_;
  ...
  public:
	...
	HHparton() : Parton::Parton(1,1,1,0.,0.,0.,0.) {
		is_shower_ = false; is_thermal_ = false; is_used_ = false; is_decayedglu_ = false; is_remnant_ = false; used_reco_ = false; used_str_ = false; is_strendpt_ = false;
		alt_id_ = 0; orig_ = 0; par_ = -1; string_id_ = 0; pos_str_ = 0; endpt_id_ = 0; sibling_ = 0; alt_mass_ = 0.;
		PY_origid_ = 0; PY_par1_ = -1; PY_par2_ = -1; PY_dau1_ = -1; PY_dau2_ = -1; PY_stat_ = 23; //PY_stat_ = 11;
