...
class thermptnsampler
{
 public:
	...
	//void hypersurface(std::vector<SurfaceCellInfo> surf_in){surface = surf_in;}
	void hypersurface(std::vector<std::vector<double>> surf_in){surface = surf_in;}
 ...
 private:
	...
	/* HyperSurface */
	//std::vector<SurfaceCellInfo> surface;
