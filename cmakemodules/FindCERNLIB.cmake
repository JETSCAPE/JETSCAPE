...
# the file "LICENSE"                       #
# ##############################################################################
# * Try to find CERNLIB Once done this will define
#
# CERNLIB_FOUND - system has CERNLIB (not needed)  CERNLIB_INCLUDE_DIR - the
# CERNLIB include directory CERNLIB_LIBRARIES - The libraries needed to use
# CERNLIB (not needed)  CERNLIB_DEFINITIONS - Compiler switches required for
# using CERNLIB
#
...
find_path(
  CERNLIB_INCLUDE_DIR
  NAMES CERNLIB
  PATHS ${SIMPATH}/cern/include $ENV{CERN_ROOT}/include
  NO_DEFAULT_PATH)

find_path(
  CERNLIB_LIBRARY_DIR
  NAMES libgeant.a libmathlib.a
  PATHS ${SIMPATH}/cern/lib $ENV{CERN_ROOT}/lib
  NO_DEFAULT_PATH)
