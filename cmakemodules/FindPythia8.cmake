...
#
# This module defines PYTHIA8_INCLUDE_DIR   where to locate Pythia.h file
# PYTHIA8_LIBRARY       where to find the libpythia8 library
# PYTHIA8_<lib>_LIBRARY Addicional libraries PYTHIA8_LIBRARIES     (not cached)
# the libraries to link against to use Pythia8 PYTHIA8_FOUND         if false,
# you cannot build anything that requires Pythia8 PYTHIA8_VERSION       version
# of Pythia8 if found
...
foreach(_lib PYTHIA8_LIBRARY PYTHIA8_hepmcinterface_LIBRARY
             PYTHIA8_lhapdfdummy_LIBRARY)
  if(${_lib})
...
# handle the QUIETLY and REQUIRED arguments and set PYTHIA8_FOUND to TRUE if all
