...
# the file "LICENSE"                       #
# ##############################################################################
# * Try to find PLUTO instalation Once done this will define
#
# Pythia6_FOUND - system has Pythia6 Pythia6_LIBRARY_DIR - The libraries
# directory for Pythia6
#
...
find_path(
  Pythia6_LIBRARY_DIR
  NAMES libPythia6.so
  PATHS ${Pythia6_DIR}/lib ${AlFa_DIR}/lib ${SIMPATH}/lib
